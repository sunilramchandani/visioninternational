...
@endsection {{--{{ dd($news) }}--}} @section('content-main')
<section class="content page-opportunities">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <a href="#" class="pop">
                <div class="img-wrap">
                    <a href="{{route ('mainnewsimage.delete', $image_preview->id)}}" onclick="return ConfirmDelete();">
                        <span class="close">&times;</span>
                    </a>

                    <img height="200px" width="200px" src="{{ URL::asset('image/uploaded_main_news_image')}}/{{$image_preview->image_name}}"
    ...
    <form action="{{route('mainnewsimage.save', $news->id)}}" method="post" role="form" enctype="multipart/form-data">
        {{csrf_field()}}
        <br>
