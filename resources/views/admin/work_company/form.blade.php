...
<section class="content-header">
    <h1>
        {{ ucwords(request()->route()->getActionMethod()) }} Work Company
    </h1>
</section>
        ...
        <div class="col-xs-12">
            ...
            <form action="{{ $action }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="company_name" name="company_name" value="{{ isset($company) ? $company->company_name : '' }}" placeholder="Some Title">
                </div>
                <div class="form-group">
                    <label for="description">
                        Description
                    </label>
                    <input type="text" class="form-control" id="description" name="description" value="{{ isset($company) ? $company->description : '' }}" placeholder="Some Title">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="housing_type" name="housing_type" value="{{ isset($company) ? $company->housing_type : '' }}" placeholder="Some Title">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="country" name="country" value="{{ isset($company) ? $company->country : '' }}" placeholder="Some Title">
                </div>
