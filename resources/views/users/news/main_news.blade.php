                    ...
                    <div class="container-fluid image-blog">
                        ...
                        <div class="row">
                            <div class="col-lg-6 share-main-title ">
                                ...
                                <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(Request::fullUrl(). '/' .$blog->i ) }}" target="_blank">
                                    <i class="fa fa-facebook-f " style="font-size:20px; padding-right:1%; color:black;"></i>
                                </a>
                                <a href="https://twitter.com/intent/tweet?url={{ urlencode(Request::fullUrl(). '/' .$blog->i) }}" target="_blank">
                                    <i class="fa fa-twitter " style="font-size:20px; padding-right:1%; color:black;"></i>
                                </a>
                                <a href="https://plus.google.com/share?url={{ urlencode(Request::fullUrl(). '/' .$blog->i) }}" target="_blank">
