...
<div class = "whole-page">
    ...
    <div class="text-center row"> 
            <div class = "row aupair">
                <div class="aupair-icon aupair-icon-left  col-lg-4 col-lg-offset-2 col-md-4 col-md-offset-2 col-sm-4 col-sm-offset-2 col-xs-5 col-xs-offset-1">
                ...
                <div class="aupair-icon aupair-icon-right col-lg-4 col-md-4 col-sm-4 col-xs-5">
    ...
    <div class="text-center row"> 
            <div class = "row aupair">
                <div class="aupair-icon2 aupair-icon-left  col-lg-4 col-lg-offset-2 col-md-4 col-md-offset-2 col-sm-4 col-sm-offset-2 col-xs-5 col-xs-offset-1">
                ...
                <div class="aupair-icon2 aupair-icon-right col-lg-4 col-md-4 col-sm-4 col-xs-5">
        ...
        <div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="text-center boxshadow row"> 
                ...
                <div class="intership-content col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    ...
                    <a href class="btn locate-me locate-me21">Download Reservation Form</a>
                </div>
             </div>
