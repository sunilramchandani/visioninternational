...
<div class = "col-xs-12 company-whole">
    <div class = "col-xs-5 picture2">
    @foreach ($internshipCompany_table as $company)
    <img src="{{ URL::asset('image/uploaded_company_image/'.$company->image)}}" class="img img-responsive img-map" alt="Company Banner" height ="100">
    @endforeach
    </div>
